        ...
        <div className="mx-auto max-w-[1400px] px-5 py-6">
            <header className="flex flex-wrap items-start justify-between gap-3">
                ...
                <div className="flex items-center gap-3 text-xs text-neutral-500">
                    ...
                    <a href="/" className="rounded-lg border border-neutral-300 px-3 py-1.5 hover:bg-neutral-50">
                        ← Herramientas
                    </a>
                    <a href="/1-5-10/evaluar" className="rounded-lg border border-neutral-300 px-3 py-1.5 hover:bg-neutral-50">
                        ✅ Evaluar
                    </a>
                    <a href="/1-5-10/campanas" className="rounded-lg border border-neutral-300 px-3 py-1.5 hover:bg-neutral-50">
                        ✉️ Campañas
                    </a>
