...
type Section = 'costo' | 'funnel' | 'deal' | 'comoleer';
...
export default function PortalesApp({ d, cacheAt, onRefresh, cargando }: {
    d: PortalesView; cacheAt: number | null; onRefresh: () => void; cargando: boolean;
}) {
                ...
                {section === 'comoleer' && (
                    <>
                        ...
                        <div style={{ marginTop: 22, paddingTop: 14, borderTop: `1px solid ${LGT}`, fontSize: 11.5, color: GRY, lineHeight: 1.6 }}>
                            Falta traer del dashboard local: el <b>pulso semanal</b> (leads y atención por
                            semana, con alertas) y el <b>histórico</b> (YTD, año contra año). Este tablero
                            cubre el bloque de costo y funnel, que es el que justificaba la mudanza.
                        </div>
                    </>
                )}
            </div>
